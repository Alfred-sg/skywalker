...
exports.default = {
    ...
    task: function (ctx) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var branch, env, version, _a, oss, objectRoot, envMap, dist, objectPrefix, dir, all_upload_tasks;
        return tslib_1.__generator(this, function (_b) {
            branch = ctx.branch;
            env = branch.env, version = branch.version;
            _a = resolve(ctx), oss = _a.oss, objectRoot = _a.objectRoot, envMap = _a.envMap, dist = _a.dist;
            console.log(chalk.blue('start to update.'));
            OssUtil.config(oss);
            objectPrefix = "" + objectRoot + (envMap && env && envMap[env] ? '/' + envMap[env] + '/' : '/') + version;
