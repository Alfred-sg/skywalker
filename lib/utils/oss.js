...
exports.upload = function (object, localfile) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var metaData, headers, contentEncoding, result, gzip, inp, stream, res, name, url, status, nameChunks, fileName;
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                check();
            ...
            case 4:
                ;
                res = result.res, name = result.name, url = result.url;
                if (!!res) return [3 /*break*/, 6];
                console.log(chalk.red(localfile) + " upload failed, retry");
                return [4 /*yield*/, exports.upload(object, localfile)];
